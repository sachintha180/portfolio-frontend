    ...
    roles: [
      {
        ...
        details: [
          ...
          "Headed procurement of IT equipment to support core business operations.",
      ...
      },
      {
        ...
        details: [
          "Built and deployed agentic AI systems for contract management and drafting.",
          ...
          "Scaled deployments with observability and automated release pipelines.",
        ],
      },
    ],
    ...
    roles: [
      {
        ...
        details: [
          ...
          "Implemented serverless architectures and SSR with Next.js to reduce hosting spend and improve response times.",
          "Applied NLP algorithms and vector databases to serve retrieval-augmented pricing and product data with high precision.",
        ],
      },
    ],
    group: "Software Sector",
    ...
    roles: [
      {
        ...
        details: [
          "Completed an industry-focused program delivering 3 production-grade projects under senior mentorship.",
          "Built full-stack solutions in C, C++ and the MERN stack to meet client-style requirements.",
          "Earned the CodeCraft award in recognition of software engineering ingenuity and skill.",
        ],
      },
    ],
    group: "Software Sector",
